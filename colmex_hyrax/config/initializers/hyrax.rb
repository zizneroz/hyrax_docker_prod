Hyrax.config do |config|
  ...
  config.contact_email = ENV['ADMIN_EMAIL'] || "zizneroz.1.00@gmail.com"
  ...
  config.google_analytics_id = 'UA-13170057-8'
  ...
  config.fits_path = ENV['FITS_PATH'] || "/home/fits1_5_0/fits.sh"
